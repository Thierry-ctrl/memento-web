  ...
  return (
    <main className="w-full flex flex-col min-h-screen">
      <section className="relative min-h-[100dvh] w-full flex items-center overflow-hidden border-b border-primary/10">
        ...
        <div className="relative z-10 flex flex-col items-start px-10 md:px-20 lg:px-28 max-w-4xl pt-20">
          <p className="eyebrow text-primary/80 mb-8">
          ...
          <p className="text-base md:text-lg text-primary/80 max-w-md mb-12 font-light leading-relaxed">
      ...
      <section className="py-32 px-6 md:px-12 bg-background relative">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="order-2 lg:order-1 relative">
            <div className="aspect-[3/4] w-full max-w-md mx-auto bg-muted overflow-hidden relative flex items-center justify-center">
          ...
          <div className="order-1 lg:order-2 flex flex-col items-start">
            <h2 className="font-serif text-5xl md:text-6xl text-primary mb-8 leading-tight">
              ...
              <span className="text-primary/70">An artifact.</span>
            </h2>
      ...
      <section className="py-24 bg-card w-full overflow-hidden flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-8 w-full max-w-[1400px] px-4 md:px-12 justify-center items-center">
          ...
          <div className="aspect-[4/5] w-full max-w-[400px] bg-muted relative md:-translate-y-12 group overflow-hidden flex items-center justify-center">
