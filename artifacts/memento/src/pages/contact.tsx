      ...
      <section className="px-6 md:px-12 max-w-5xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24">
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <span className="text-primary/70 font-light mt-1 text-sm">+250 788 628 735</span>
                </a>
                ...
                >
                  ...
                  <span className="text-primary/70 font-light mt-1 text-sm">0788 628 735</span>
                </a>
                ...
                {import.meta.env.VITE_PUBLIC_CONTACT_EMAIL && (
                  ...
                  >
                    ...
                    <span className="text-primary/70 font-light mt-1 text-sm">{import.meta.env.VITE_PUBLIC_CONTACT_EMAIL}</span>
                  </a>
                )}
              </div>
            </div>
          ...
          <div className="flex flex-col justify-center">
            <h3 className="font-serif text-4xl text-primary mb-6">Ready to request a date?</h3>
